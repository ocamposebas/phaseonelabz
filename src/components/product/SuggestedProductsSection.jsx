...
/*
  No usamos product.permalink porque manda a WordPress.
  Usamos la ruta local de Astro.
*/
...
export default function SuggestedProductsSection({
  ...
  return (
    <section className="suggested-catalog-section relative overflow-hidden py-12 text-white sm:py-16 lg:py-20">
                ...
                <div className="px-0.5 pb-1 pt-3 sm:px-1 sm:pt-5">
                  <div className="mb-2 flex items-center justify-between gap-2 sm:mb-3">
                    <span className="text-[7.5px] font-black uppercase tracking-[0.12em] text-cyan-200/55 sm:text-[10px] sm:tracking-[0.18em]">
                      {product.suggestedLabel || "Suggested"}
                    </span>
                  ...
                  >
                    ...
                    {isInStock ? (isVariable ? "Choose" : "Add") : "Out"}
                  </button>
                </div>
              </article>
            );
